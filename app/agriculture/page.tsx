...
export const metadata: Metadata = {
  title: "Agriculture Information | Farming Guides & Resources",
  description: "Comprehensive agriculture resources, farming guides, crop management information, and sustainable agriculture practices for modern farmers.",
  keywords: ["agriculture", "farming guides", "agriculture information", "crop management", "farming resources"],
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    type: "website",
    title: "Agriculture Information | Farming Guides & Resources",
    description: "Comprehensive agriculture resources and farming guides",
      ...
      <div className="min-h-screen bg-white font-sans text-zinc-900">
        ...
        <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-green-700">Agriculture Blogs</span>
          </div>
          <div className="hidden md:flex gap-8 text-sm font-medium text-zinc-600">
            ...
            <a href="/trending" className="hover:text-green-600">Trending</a>
            <a href="/agriculture" className="hover:text-green-600">Agriculture</a>
          </div>
